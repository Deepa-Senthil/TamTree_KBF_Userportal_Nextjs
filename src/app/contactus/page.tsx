...
const ContactUs = () => {
  return (
    <>
      <Head>
        <title>Contact Us | Kathir Baby Foods</title>
        <meta
          name="description"
          content="Contact Kathir Baby Foods for queries, orders, or support via WhatsApp, Email, Instagram or Google Business Page. We’re here to help!"
        />
      </Head>
