    ...
    <>
      ...
      <div className={styles.drawer}>
          ...
          <div className={styles.footer}>
            <div className={styles.orderInfo}>
              <p className={styles.infoHeader}>
                <span className={styles.starIcon}>★</span> Every order is
                freshly prepared and dispatched safely.
              </p>
              <h3>Order Processing & Shipping Details:</h3>
              <ol className={styles.infoList}>
                <li>
                  <strong>Confirm & Send Your Order</strong> - Share your
                  product list with us along with your details.
                </li>
                <li>
        ...
        <OrderSuccessModal
          ...
          onClose={() =>
            setOrderSuccess({ ...orderSuccess, showSuccess: false })
          }
